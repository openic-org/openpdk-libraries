...
w=4.9e-6
l=4.9e-6
lvs_format="tcleval(@name @pinlist @model A=26.106p P=175.84u )"
}
...
w=66.44e-6
l=66.44e-6
lvs_format="tcleval(@name @pinlist @model A=4313.4p P=594.62u)"
}
...
C {sg13g2_Clamp_P8N8D.sym} -40 -310 0 1 {name=x5}
